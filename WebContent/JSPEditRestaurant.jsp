...
<body class="blurBg-false" style="background-color:#EBEBEB">
	<link rel="stylesheet" href="addrestaurant_files/formoid1/formoid-solid-green.css" type="text/css" />
	<script type="text/javascript" src="addrestaurant_files/formoid1/jquery.min.js"></script>
	<form class="formoid-solid-green" style="background-color:#1A2223;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#30deb3;max-width:480px;min-width:150px" method="post" action="sManageRestaurants">
	<div class="title"><h2>Edit Restaurant</h2></div>
	<div class="element-separator">
		<hr><h3 class="section-break-title">Personal Information</h3>
	</div>
		<div class="element-input" title="Name ">
		<label class="title"></label>
		<div class="item-cont">
			<input class="large" type="text" name="name" value="${restaurant.name}" placeholder="Name"/><span class="icon-place"></span>
		</div>
	</div>
	<div class="element-input">
		<label class="title"></label>
		<div class="item-cont">
			<input class="large" type="text" name="cif" value="${restaurant.cif}" placeholder="CIF"/><span class="icon-place"></span>
		</div>
	</div>
	<div class="element-email"><label class="title"></label>
		<div class="item-cont">
			<input class="large" type="email" name="email" value="${restaurant.email}" placeholder="Email"/><span class="icon-place"></span>
		</div>
	</div>
	<div class="element-phone">
		<label class="title"></label>
		<div class="item-cont">
			<input class="large" type="tel" pattern="[+]?[\.\s\-\(\)\*\#0-9]{3,}" maxlength="24"  name="phone" value="${restaurant.phone}" placeholder="Phone"/><span class="icon-place"></span>
		</div>
	</div>
	<div class="element-separator">
		<hr><h3 class="section-break-title">Contact Information</h3>
	</div>
	<div class="element-address"><label class="title">
		</label><span class="addr1">
		<input placeholder="Street Address" type="text"  name="address" value="${restaurant.address}" /><span class="icon-place"></span></span><span class="city">
		<input placeholder="City" type="text"  name="city" value="${restaurant.city}" /><span class="icon-place"></span></span><span class="state">
		<input placeholder="State" type="text"  name="state" value="${restaurant.state}" /><span class="icon-place"></span></span><span class="zip">
		<input placeholder="Postal Code" type="text" maxlength="15" name="postalcode" value="${restaurant.postalCode}" /><span class="icon-place"></span></span><div class="country">
		<select name="country" id="country" value="${restaurant.country}" >
			...
			<option value="Australia">Australia</option><option value="Canada">Canada</option><option value="France">France</option>
			<option value="New Zealand">New Zealand</option><option value="India">India</option><option value="Brazil">Brazil</option>
			<option value="----" disabled="disabled">----</option><option value="Afghanistan">Afghanistan</option>
			<option value="Aland Islands">Aland Islands</option><option value="Albania">Albania</option><option value="Algeria">Algeria</option>
	...
	<script type="text/javascript" src="addrestaurant_files/formoid1/formoid-solid-green.js"></script>
	<script type="text/javascript">
		var a = document.getElementById('country').getElementsByTagName('option');
		for (i = 0; i<a.length;i++)
		{
			if (a[i].value == '${restaurant.country}')
			{
				a[i].selected=true;
			}
		}
